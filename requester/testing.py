...
source = requests.get('https://iohk.io/blog/stake-pools-in-cardano/')
low_soup = BeautifulSoup(source.text, 'html.parser')
...
def get_clean_article(user_str, soup):
    ...
    clean_article = update_result.split()
    return clean_article

# print([(w.text, w.pos_) for w in anal_text])
# print([(w.text, w.pos_) for w in doc])

# print(cleanlist)
# string = subsoup.prettify()
# print(string)
# print(string.index('<a href="https://scrapinghub.com">'))
# print("")
# print("")

# my_regexp = r"^" + re.escape('Random') + r"$"

# foundstring = subresults.find("Thomas")
# foundcontent = subresults.content[1445]
#
# print("foundstring: ", foundstring)
# print("foundcontent: ", foundcontent)
# print("foundstring parent: ", foundstring.parent)
#
# stringparent = subsoup.find(text=foundstring.parent)
# print("foundstring parent: ", stringparent)
